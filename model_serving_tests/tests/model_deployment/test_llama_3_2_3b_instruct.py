...
#from model_serving_tests.endpoint_utility.openai_utility import wait_for_openai_server
...
def test_llama_3_2_3b_instruct_simple(client: DynamicClient,
    ...
    if deployment_type.lower() == "rawdeployment":
        ...
        #if model_name.startswith("llama-3") and accelerator_type == "cpu":
        #    pytest.xfail("Chat completions are not supported for Llama‑3 models on this vLLM CPU runtime")
